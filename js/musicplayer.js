// Creating styles and functionality for the custom audio tag (It's tons of code for a simple functionality)
// This utilizes the AudioContext API
{
        ...
        <style>
          ...
          * {
          ...
          .play-btn {
              ...
              min-width: 30px;
              height: 30px;
              background: url("../img/audioplayer.png") 0 center/500% 100% no-repeat;
              appearance: none;
              border: none;
          ...
          .play-btn.playing {
              background: url("../img/audioplayer.png") 25% center/500% 100% no-repeat;
          }
          ...
          .volume-bar {
              ...
              min-width: 30px;
              height: 30px;
              background: url("../img/audioplayer.png") 50% center/500% 100% no-repeat;
              position: relative;
          }
          
          .volume-bar.half {
              background: url("../img/audioplayer.png") 75% center/500% 100% no-repeat;
          }
          .volume-bar.over {
              background: url("../img/audioplayer.png") 100% center/500% 100% no-repeat;
          }
          ...
          .progress-bar::-webkit-slider-thumb {
              ...
              height: 20px;
              width: 0;
              box-shadow: -3000px 0 0 3000px #ffffff38;
          }
          ...
          .progress-bar::-moz-range-thumb {
              ...
              height: 20px;
              width: 0;
              box-shadow: -3000px 0 0 3000px #ffffff21;
          }
